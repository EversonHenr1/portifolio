function linguagens(valor){
    ...
    if(valor == "html"){
       ...
       desc.innerHTML = 'Dentro da linguagem <strong>HTML 5</strong> ja realizei alguns projetos academicos, como criar um site para um <strong>Zoologico</strong> e um site para uma <strong>academia</strong>; durante esses projetos aprendir como utilizar a linguagem não somente para a criação de <strong>websites</strong>, mas também tendo um significado semantico correto.'
        ...
        desc.innerHTML = 'Atualmente estou tendo aulas de Praticas profissionais utilizando <strong>Linguagem C </strong>, dentro dessa diciplina estou aprendendo funcionalidades dessa linguagem e logica de programação, alguns programas desenvolvidos podem ser visualizados <a href="">aqui</a>'
    }else if(valor == "sql"){
        ...
        imagem.alt ='xml'
        desc.innerHTML ='Com <strong>Xml</strong> desenvolvi um layout inteiro de uma aplicação movel que pode ser visualizada <a href="">aqui</a>.<br> utilizando <strong>Android Studio </strong> aprendir conceitos de layout, drawable, Fragments.'
    }else if(valor == "java"){
